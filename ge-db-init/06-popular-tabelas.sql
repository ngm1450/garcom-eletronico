...
INSERT INTO pagamentos (valor) VALUES (150.00);
INSERT INTO pagamentos (valor) VALUES (91.90);
INSERT INTO pagamentos (valor) VALUES (200.00);
...
INSERT INTO contas (nome, pagamento_id, mesa_id, status, desconto, data_criacao) VALUES
('Mesa 10 - Jantar', 2, 1, 'PAGA', 0.0, NOW());

INSERT INTO conta_caixa_gerencia (conta_id, caixa_id) VALUES (1, 2);

INSERT INTO pedidos (numero, horario_pedido, conta_id, cliente_id, cozinha_id, status) VALUES
(1001, NOW() - INTERVAL '30 minutes', 1, 1, 3, 'PRONTO');

INSERT INTO itens_pedido (quantidade, pedido_id, item_cardapio_id, status) VALUES
(1.0, 1, 1, 'PRONTO'),
(1.0, 1, 2, 'PRONTO');